...
LvCanvas& LvCanvas::setBuffer(void *buf, lv_coord_t w, lv_coord_t h, lv_color_format_t cf){
...
lv_color32_t LvCanvas::getPx(lv_coord_t x, lv_coord_t y) const noexcept {
